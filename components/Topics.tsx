    ...
    <section className="max-w-[1200px] mx-auto px-8 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {topics.map((topic) => (
          ...
          >
            <span className="absolute top-6 right-6 font-[--font-libre-baskerville] text-[2rem] font-bold text-[--border] group-hover:text-[--cyan] transition-colors">
              {topic.number}
            </span>
            ...
            <p className="text-[0.95rem] text-[--text-muted] leading-relaxed">{topic.description}</p>
          </div>
        ))}
      </div>
    </section>
