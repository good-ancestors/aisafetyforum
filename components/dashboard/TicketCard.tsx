...
export default function TicketCard({
  ...
  return (
    <div className="border-l-4 border-cyan bg-light p-4 rounded-r">
      <div className="flex justify-between items-start">
        <div className="flex-1">
          ...
          <p className="text-sm text-muted">Receipt: {receiptId}</p>
          {orderId && (
            <p className="text-xs text-muted mt-1">Order {orderId}</p>
          )}
