  ...
  return (
    <section className="relative bg-gradient-to-br from-navy via-navy-light to-brand-blue text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-12">
        <div className="absolute w-[300px] h-[300px] rounded-full border-2 border-cyan -top-[100px] right-[10%] animate-[float_20s_ease-in-out_infinite]" />
        <div className="absolute w-[200px] h-[200px] border-2 border-cyan top-[60%] right-[5%] rotate-45 animate-[float_15s_ease-in-out_infinite_reverse]" />
        <div className="absolute w-[150px] h-[150px] rounded-full border-2 border-cyan -bottom-[50px] left-[5%] animate-[float_18s_ease-in-out_infinite]" />
        <div className="absolute w-[100px] h-[100px] border-2 border-cyan top-[20%] left-[15%] rotate-[15deg] animate-[float_12s_ease-in-out_infinite_reverse]" />
        <div className="absolute w-20 h-20 rounded-full bg-cyan top-[30%] right-[35%] opacity-40" />
      </div>
