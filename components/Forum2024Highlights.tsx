...
export default function Forum2024Highlights() {
  return (
    <section className="bg-gradient-to-br from-[#0a1f5c] to-[#0047ba] text-white py-20">
      <div className="max-w-[1200px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <div className="text-[3rem] font-serif font-bold text-[#00d4ff] mb-2">90%+</div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <div className="text-[3rem] font-serif font-bold text-[#00d4ff] mb-2">70%</div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <div className="text-[3rem] font-serif font-bold text-[#00d4ff] mb-2">170</div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10 mb-8">
          <h3 className="font-serif text-xl font-bold mb-4 text-[#00d4ff]">Immediate Impact</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#00d4ff] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
