export default function About() {
  return (
    <section id="about" className="bg-white border-t border-b border-[#e0e4e8]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="space-y-6">
            ...
            <p className="text-lg leading-relaxed text-[#333333]">
              ...
              <a href="https://www.industry.gov.au/news/australia-establish-new-institute-strengthen-ai-safety" target="_blank" rel="noopener noreferrer" className="text-[#0047ba] hover:text-[#0099cc] underline transition-colors">
                AI Safety Institute
            ...
            <p className="text-lg leading-relaxed text-[#333333]">
              ...
              <a href="/2024" className="text-[#0047ba] hover:text-[#0099cc] underline transition-colors">
                2024 forum
              </a>{' '}
          ...
          <ul className="space-y-0">
            <li className="flex items-start gap-4 py-5 border-b border-[#e0e4e8]">
              <div className="relative w-12 h-12 rounded-[10px] bg-gradient-to-br from-[#0a1f5c] to-[#0047ba] flex items-center justify-center flex-shrink-0 after:content-[''] after:absolute after:w-3 after:h-3 after:bg-[#00d4ff] after:rounded-full after:-top-1 after:-right-1 after:shadow-[0_0_8px_var(--cyan)]">
              ...
              <div>
                <strong className="block text-lg text-[#0a1f5c] mb-1">Timely & Relevant</strong>
            ...
            <li className="flex items-start gap-4 py-5">
              ...
              <div>
                <strong className="block text-lg text-[#0a1f5c] mb-1">Cross-Sector Collaboration</strong>
                <span className="text-[0.95rem] text-[#5c6670] leading-relaxed">
