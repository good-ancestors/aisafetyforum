      ...
      <div className="flex border-b border-border">
        <button
          ...
          className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${
            activeTab === 'speakers'
              ? 'text-navy border-b-2 border-navy bg-light'
      ...
      <div className="divide-y divide-border">
        {activeTab === 'speakers' ? (
          filteredSpeakers.length === 0 ? (
            <div className="p-8 text-center text-muted">No speaker proposals found</div>
          ) : (
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    {expandedId === proposal.id && (
                      <div className="mt-3 p-3 bg-light rounded text-sm space-y-2">
                        <div>
            ...
            <div key={app.id} className="p-4">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted mt-2 line-clamp-2">{app.whyAttend}</p>
                  <button
                  ...
                  {expandedId === app.id && (
                    <div className="mt-3 p-3 bg-light rounded text-sm space-y-3">
                      <div>
                        <p className="font-medium text-navy">Why attend:</p>
                        <p className="whitespace-pre-wrap text-body">{app.whyAttend}</p>
                      </div>
                      {app.travelSupport && (
                        <p className="text-muted">
