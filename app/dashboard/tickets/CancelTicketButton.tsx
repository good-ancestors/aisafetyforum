                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">
                      This ticket was paid by invoice. After cancellation, please <a href="/contact" className="underline">contact us</a> to arrange a refund of <strong>${refundAmount} AUD</strong>.
                    </p>
                  </div>
                </div>
              </div>
