                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">
                      This order was paid by invoice. After cancellation, please contact us at <a href="mailto:contact@aisafetyforum.au" className="underline">contact@aisafetyforum.au</a> to arrange a refund of <strong>${refundAmount} AUD</strong>.
                    </p>
                  </div>
                </div>
              </div>
